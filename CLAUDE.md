...
- **панель черновика знает про вход заранее** (проп со страницы) и потому не обещает того,
  ...
  только повторяла бы разговор. Подсказка слева об этом и говорит: «войдите, и он сам
  уедет в вашу коллекцию». Это **единственное** место, где вход спрашивается заранее ради
  того, показывать кнопку или нет, а не ради того, куда ляжет сезон;
...
- **разговор о потере один, и он про «сейчас».** Красное предупреждение (`warning`,
  ...
  вход сам увозит черновик в коллекцию, а про хранение говорит подсказка панели
  черновика — окну заведения незачем вести тот же разговор второй раз;
