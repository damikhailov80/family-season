...
- **Мегафон у выложенного сезона нажат и окна не открывает** — он уводит на копию.
  Прежде он предлагал выложить сезон, который уже на витрине: нажимать можно было
  сколько угодно раз, и каждый раз человек приезжал на ту же копию с отказом «такой
  сезон уже есть». Знание это **выведенное, а не хранимое**:
  `publishedCode` сверяет содержимое тем же `content_key`,
  которым витрина держит уникальность, — указателя на публикацию у личного сезона
  по-прежнему нет. Отсюда и приятное следствие: правку витрина не видит, и после правки
  кнопка сама собой возвращается в исходное — на витрине лежит уже не этот текст.
  Спрашиваем только в просмотре: в правке ответ устарел бы на первом нажатии клавиши.
...
- **Жалоба живёт дольше публикации, поэтому носит снимок, а не ссылку.** В строке лежат
  ...
  жалобе собственную память. Имена в снимок не идут: жалуются на содержимое, а имена —
  персональные данные и в сравнении публикаций не участвуют. Копию повторная жалоба не
