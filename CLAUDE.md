...
| --- | --- | --- | --- | --- |
| 1 | Свой сезон в просмотре | `custom` | `view` | `/sheet#d=…&p=…` |
| 2 | Свой сезон в правке | `custom` | `edit` | `/sheet/edit#d=…&p=…` |
| 3 | Пример: постер плюс заполнение | `demo` | `view` | `/sheet#d=…&p=…&data=<id>` |
...
- **тема доступна всегда** — она не часть бланка, её несёт `p=` (см. «Темы оформления»);
