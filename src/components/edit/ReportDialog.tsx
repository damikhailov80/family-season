  ...
  return (
    ...
    >
      ...
      <p className={styles.text}>
        {sent
          ? 'Вы уже жаловались на этот сезон. Новый текст заменит прежний — второй жалобы не появится.'
          : 'Помогите нам сделать витрину лучше. Напишите, если увидели рекламу, грубые или расистские высказывания, чужие личные данные — словом, то, чему на семейном постере не место. Жалоба придёт нам, а не автору постера: вашего сообщения он не увидит.'}
      </p>
