  ...
  return (
    <dialog className={styles.dialog} ref={dialog} onClose={onDismiss} aria-labelledby="share-link">
      ...
      <p className={styles.text}>
        {token
          ? 'По этой ссылке сезон откроется у кого угодно — вход не нужен. Править его смогут только вы; получатель сможет посмотреть, распечатать и форкнуть себе. Выдадите новую — прежняя перестанет работать.'
          : 'Пока ссылки нет, и сезон видите только вы. Ссылка открывает его любому, у кого она есть, — без входа и без аккаунта. Отозвать её можно в любой момент.'}
      </p>
