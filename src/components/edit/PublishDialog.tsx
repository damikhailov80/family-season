 ...
 *
 * Окно объясняет то, что после нажатия уже не отыграть словами: на витрину
 * уезжает **копия**, и связь с этим сезоном обрывается. Дальше правки в кабинете
 * витрину не трогают, а выложенное живёт своей жизнью и по своей ссылке.
 *
  ...
  return (
    <dialog className={styles.dialog} ref={dialog} onClose={onDismiss} aria-labelledby="publish">
      ...
      <p className={styles.text}>
        Копия сезона появится в «Идеях сообщества» и получит свою постоянную ссылку. Дальше
        она живёт сама по себе: правки в этом сезоне на неё не влияют, а удаление его отсюда
        её не уносит. Одинаковых сезонов витрина не держит — тема и рисунки при этом не в
        счёт, сравнивается сам бланк.
      </p>

      <label className={styles.check}>
        <input className={styles.checkBox} ref={anonymize} type="checkbox" />
        <span>Заменить имена на случайные — на витрине семью будут звать иначе</span>
      </label>
