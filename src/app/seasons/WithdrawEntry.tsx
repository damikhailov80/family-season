 ...
 * другого — исчезнет вместе с лайками.
 *
      ...
      <dialog className={styles.dialog} ref={dialog} aria-labelledby={`off-${code}`}>
        ...
        <p className={styles.dialogText}>
          {favorites > 0
            ...
            : 'Публикация исчезнет совсем — вместе с лайками. Останется она только в одном случае: если на неё пожаловались, и жалобу ещё не разобрали. Ваш собственный сезон это не тронет: на витрине лежит его копия.'}
        </p>
