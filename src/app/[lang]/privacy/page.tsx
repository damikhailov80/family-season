...
/**
 * Абзац с выделением: в словаре оно размечено `**звёздочками**`. Разметки
 * богаче этой в текстах нет — здесь она нужна потому, что смысл держится на
 * нескольких словах, и резать их на отдельные ключи значит отдать перевод
 * кусками, из которых фразу уже не собрать.
 */
 ...
 *
 * Текст описывает сегодняшнюю правду: настройки кабинета (язык и состав семьи),
 * свои сезоны, их копии на витрине, личные ссылки, лайки, жалобы и избранное.
 * Имени и почты в базе нет по-прежнему. Появится там что-то ещё — переписывать
 * эту страницу нужно **в том же изменении**, иначе она начнёт врать (см. «Мои
 * сезоны» и «Витрина» в CLAUDE.md).
 */
