  ...
  return (
    <PaperSheet>
      <SectionBox accent="theme" label="Идеи сообщества" note="скоро" className={styles.section}>
        ...
        <p className={styles.text}>
          Пока витрина пуста, и причина честная: сайт ещё не умеет публиковать сезоны.
          Сохранённый сезон лежит в вашем кабинете и виден только вам; показать его можно
          пока одним способом — отправить ссылку.
        </p>
